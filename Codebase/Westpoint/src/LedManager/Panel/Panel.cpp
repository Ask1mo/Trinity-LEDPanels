...
void Panel::setDiodeDataFx(uint16_t diodeNumber, uint8_t brightness, uint8_t effect, uint8_t colour, uint16_t offset, uint8_t speed, bool repeat)
{
  d = 0;
  fxProgression = 0;
  fxCycleProgression = 0;
  offsetTimer = 0;
